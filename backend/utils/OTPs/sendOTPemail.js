...
const sendOTPemail = asyncHandler(async ({ _id, email }, res) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Your Paynalyze Account Verification OTP",
    html: `
    <html>
      <head>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2>OTP Verification for Spend  Account</h2>
          </div>
          <div class="content">
            <p>Dear User,</p>
            <p>Your OTP for verifying your Paynalyzet account is: <strong>${otp}</strong></p>
            <p>This OTP is valid for 1 minute. Please use it within this time period.</p>
            <p>If you did not request this OTP, please ignore this email.</p>
            <p>Thank you for choosing Paynalyze!</p>
          </div>
          <div class="footer">
